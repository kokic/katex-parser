...
fn build_builtin_symbols() -> SymbolRegistry {
    ...
    registry.define_symbol(Mode::Math, SymbolGroup::SpacingGroup, "\u{A0}", "\\ ", false);
    registry.define_symbol(Mode::Math, SymbolGroup::SpacingGroup, "\u{A0}", "\\space", false);
    registry.define_symbol(Mode::Math, SymbolGroup::SpacingGroup, "\u{A0}", "\\nobreakspace", false);
    registry.define_symbol(Mode::Text, SymbolGroup::SpacingGroup, "\u{A0}", "\\ ", false);
    registry.define_symbol(Mode::Text, SymbolGroup::SpacingGroup, "\u{A0}", " ", false);
    registry.define_symbol(Mode::Text, SymbolGroup::SpacingGroup, "\u{A0}", "\\space", false);
    registry.define_symbol(Mode::Text, SymbolGroup::SpacingGroup, "\u{A0}", "\\nobreakspace", false);
